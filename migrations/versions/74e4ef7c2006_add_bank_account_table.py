...
Revision ID: 74e4ef7c2006
Revises: b1f58fa7795c
Create Date: 2025-05-31 04:10:28.125659
...
revision: str = '74e4ef7c2006'
down_revision: Union[str, None] = 'b1f58fa7795c'
...
def upgrade() -> None:
    ...
    sa.Column('currency', sa.Enum('USD', 'EUR', 'GBP', 'NGN', name='accountcurrencyenum'), nullable=False),
