...
Revision ID: 1fdfb8ba800f
Revises: 28609dd72173
Create Date: 2025-06-27 23:48:21.335799
...
revision: str = '1fdfb8ba800f'
down_revision: Union[str, None] = '28609dd72173'
...
def upgrade() -> None:
    ...
    sa.Column('currency', sa.Enum('USD', 'EUR', 'GBP', 'NGN', name='virtualcardcurrencyenum'), nullable=False),
