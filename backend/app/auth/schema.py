...
class RoleChoicesSchema(str, Enum):
    CUSTOMER = "customer"
    ACCOUNT_EXCECUTIVE = "account_executive"
...
class BaseUserSchema(SQLModel):
    ...
    account_status: AcccountStatusSchema = Field(default=AcccountStatusSchema.INACTIVE)
